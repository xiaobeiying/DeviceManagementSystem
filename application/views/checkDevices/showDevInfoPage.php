...
<div id="show_dev_inifo_page_div">
	<table class="table table-bordered">
		<tr class="info_table">
			<td>设备id: <?php echo $jdata->id;?></td>
			<td>设备名: <?php echo $jdata->device_name;?></td>
			<td>设备型号: <?php echo $jdata->model;?></td>
			<td>设备编号: <?php echo $jdata->theNum;?></td>
			<td>借出时间: <?php echo $jdata->borrow_time;?></td>
		</tr>
		<tr class="info_table">
			<td>状态: <?php if($jdata->status == 0){
				...
				echo "已借出";
			};?></td><td>借阅者: <?php echo $jdata->borrower;?></td>
			<td>所属:  <?php echo $jdata->owner;?></td>
			<td>系统版本: <?php echo $jdata->version;?></td>
			<td>添加时间: <?php echo $jdata->add_time;?></td>
		</tr>
		<tr class="info_table">
